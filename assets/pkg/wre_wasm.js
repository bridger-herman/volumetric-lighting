import { loadWreScript } from './snippets/wre-dd34bbe426ca6729/assets/loadWreScript.js';
...
function __wbg_elem_binding2(arg0, arg1, arg2) {
    wasm.__wbg_function_table.get(23)(arg0, arg1, addHeapObject(arg2));
}
function __wbg_elem_binding3(arg0, arg1, arg2, arg3) {
    wasm.__wbg_function_table.get(191)(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
* @returns {any}
*/
export function time_dt() {
    const ret = wasm.time_dt();
    return takeObject(ret);
}
...
* @param {Vec3} pos
*/
export function set_camera_position(pos) {
    _assertClass(pos, Vec3);
    const ptr0 = pos.ptr;
    pos.ptr = 0;
    wasm.set_camera_position(ptr0);
}

/**
* @param {Vec3} direction
*/
export function start_moving_camera(direction) {
    _assertClass(direction, Vec3);
    const ptr0 = direction.ptr;
    direction.ptr = 0;
    wasm.start_moving_camera(ptr0);
}

/**
*/
export function stop_moving_camera() {
    wasm.stop_moving_camera();
}

/**
* @param {Vec2} delta
*/
export function add_camera_rotation(delta) {
    _assertClass(delta, Vec2);
    const ptr0 = delta.ptr;
    delta.ptr = 0;
    wasm.add_camera_rotation(ptr0);
}
...
* @returns {PointLight}
*/
export function get_point_light(index) {
    const ret = wasm.get_point_light(index);
    return ret === 0 ? undefined : PointLight.__wrap(ret);
}
...
* @param {PointLight} p
*/
export function set_point_light(index, p) {
    _assertClass(p, PointLight);
    const ptr0 = p.ptr;
    p.ptr = 0;
    wasm.set_point_light(index, ptr0);
}
...
* @returns {SpotLight}
*/
export function get_spot_light(index) {
    const ret = wasm.get_spot_light(index);
    return ret === 0 ? undefined : SpotLight.__wrap(ret);
}
...
* @param {SpotLight} p
*/
export function set_spot_light(index, p) {
    _assertClass(p, SpotLight);
    const ptr0 = p.ptr;
    p.ptr = 0;
    wasm.set_spot_light(index, ptr0);
}
...
* @returns {any}
*/
export function load_scene_async(scene_path) {
    const ret = wasm.load_scene_async(passStringToWasm(scene_path), WASM_VECTOR_LEN);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function load_text_resource(path) {
    const ret = wasm.load_text_resource(passStringToWasm(path), WASM_VECTOR_LEN);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function load_image_resource(path) {
    const ret = wasm.load_image_resource(passStringToWasm(path), WASM_VECTOR_LEN);
    return takeObject(ret);
}
...
export class Material {
    ...
    */
    get specular() {
        const ret = wasm.__wbg_get_material_specular(this.ptr);
        return Vec4.__wrap(ret);
    }
    /**
    * @param {Vec4} arg0
    */
    set specular(arg0) {
        ...
        const ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_material_specular(this.ptr, ptr0);
    }
    /**
    * @param {number} shader_id
    * @param {Vec4} color
    * @param {Vec4 | undefined} specular
    * @param {number | undefined} texture_id
    * @returns {Material}
    */
    constructor(shader_id, color, specular, texture_id) {
        _assertClass(color, Vec4);
        const ptr0 = color.ptr;
        color.ptr = 0;
        let ptr1 = 0;
        if (!isLikeNone(specular)) {
            _assertClass(specular, Vec4);
            ptr1 = specular.ptr;
            specular.ptr = 0;
        }
        const ret = wasm.material_new(shader_id, ptr0, ptr1, !isLikeNone(texture_id), isLikeNone(texture_id) ? 0 : texture_id);
        return Material.__wrap(ret);
    }
    /**
    * Partial implementation of wavefront obj mtl parsing (diffuse + specular
    * + diffuse texture only)
    * @param {string} mtl_text
    * @returns {Material}
    */
    static from_mtl_str(mtl_text) {
        const ret = wasm.material_from_mtl_str(passStringToWasm(mtl_text), WASM_VECTOR_LEN);
        return Material.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    get texture_id() {
        const retptr = 8;
        const ret = wasm.material_texture_id(retptr, this.ptr);
        const memi32 = getInt32Memory();
    ...
    * @param {number | undefined} texture_id
    */
    set texture_id(texture_id) {
        wasm.material_set_texture_id(this.ptr, !isLikeNone(texture_id), isLikeNone(texture_id) ? 0 : texture_id);
    }
}
/**
*/
export class PointLight {
    ...
    static __wrap(ptr) {
        const obj = Object.create(PointLight.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_pointlight_free(ptr);
    }
    /**
    ...
    */
    get position() {
        const ret = wasm.__wbg_get_pointlight_position(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * The light\'s position
    ...
    */
    set position(arg0) {
        ...
        const ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_pointlight_position(this.ptr, ptr0);
    }
    /**
    * The light\'s color
    * @returns {Vec3}
    */
    get color() {
        const ret = wasm.__wbg_get_pointlight_color(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * The light\'s color
    ...
    */
    set color(arg0) {
        ...
        const ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_pointlight_color(this.ptr, ptr0);
    }
    /**
    * @returns {number}
    */
    get halo_intensity() {
        const ret = wasm.__wbg_get_pointlight_halo_intensity(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set halo_intensity(arg0) {
        wasm.__wbg_set_pointlight_halo_intensity(this.ptr, arg0);
    }
    /**
    * @param {Vec3} position
    * @param {Vec3} color
    * @param {number} halo_intensity
    * @returns {PointLight}
    */
    constructor(position, color, halo_intensity) {
        _assertClass(position, Vec3);
        const ptr0 = position.ptr;
        position.ptr = 0;
        _assertClass(color, Vec3);
        const ptr1 = color.ptr;
        color.ptr = 0;
        const ret = wasm.pointlight_new(ptr0, ptr1, halo_intensity);
        return PointLight.__wrap(ret);
    }
}
/**
...
export class Quat {
    ...
    */
    to_ypr() {
        const ptr = this.ptr;
        this.ptr = 0;
        const ret = wasm.quat_to_ypr(ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @returns {Quat}
...
export class SpotLight {
    ...
    static __wrap(ptr) {
        const obj = Object.create(SpotLight.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_spotlight_free(ptr);
    }
    /**
    * @returns {Vec3}
    */
    get direction() {
        const ret = wasm.__wbg_get_spotlight_direction(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @param {Vec3} arg0
    */
    set direction(arg0) {
        ...
        const ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_spotlight_direction(this.ptr, ptr0);
    }
    /**
    * @returns {number}
    */
    get angle_inside() {
        const ret = wasm.__wbg_get_spotlight_angle_inside(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set angle_inside(arg0) {
        wasm.__wbg_set_spotlight_angle_inside(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get angle_outside() {
        const ret = wasm.__wbg_get_spotlight_angle_outside(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set angle_outside(arg0) {
        wasm.__wbg_set_spotlight_angle_outside(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get halo_intensity() {
        const ret = wasm.__wbg_get_spotlight_halo_intensity(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set halo_intensity(arg0) {
        wasm.__wbg_set_spotlight_halo_intensity(this.ptr, arg0);
    }
    /**
    * @param {Vec3} position
    * @param {Vec3} color
    * @param {Vec3} direction
    * @param {number} angle_inside
    * @param {number} angle_outside
    * @param {number} halo_intensity
    * @returns {SpotLight}
    */
    constructor(position, color, direction, angle_inside, angle_outside, halo_intensity) {
        _assertClass(position, Vec3);
        const ptr0 = position.ptr;
        position.ptr = 0;
        _assertClass(color, Vec3);
        ...
        color.ptr = 0;
        _assertClass(direction, Vec3);
        const ptr2 = direction.ptr;
        direction.ptr = 0;
        const ret = wasm.spotlight_new(ptr0, ptr1, ptr2, angle_inside, angle_outside, halo_intensity);
        return SpotLight.__wrap(ret);
    }
    /**
    * @param {Vec3} arg0
    */
    set position(arg0) {
        ...
        const ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_spotlight_position(this.ptr, ptr0);
    }
    /**
    * @param {Vec3} arg0
    */
    set color(arg0) {
        ...
        const ptr0 = arg0.ptr;
        arg0.ptr = 0;
        wasm.__wbg_set_spotlight_color(this.ptr, ptr0);
    }
    /**
    * @returns {Vec3}
    */
    get position() {
        const ret = wasm.__wbg_get_spotlight_position(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @returns {Vec3}
    */
    get color() {
        const ret = wasm.__wbg_get_spotlight_color(this.ptr);
        return Vec3.__wrap(ret);
    }
}
/**
...
export class Transform {
    ...
    */
    get right() {
        const ret = wasm.transform_right(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @returns {Vec3}
    */
    get up() {
        const ret = wasm.transform_up(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @returns {Vec3}
    */
    get forward() {
        const ret = wasm.transform_forward(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @param {Vec3} right
    ...
    * @param {Vec3} forward
    */
    set_basis(right, up, forward) {
        _assertClass(right, Vec3);
        _assertClass(up, Vec3);
        _assertClass(forward, Vec3);
        wasm.transform_set_basis(this.ptr, right.ptr, up.ptr, forward.ptr);
    }
}
/**
...
export class Vec2 {
    ...
    */
    neg() {
        const ret = wasm.vec2_neg(this.ptr);
        return Vec2.__wrap(ret);
    }
    /**
    * @returns {string}
...
export class Vec3 {
    ...
    */
    neg() {
        const ret = wasm.vec3_neg(this.ptr);
        return Vec3.__wrap(ret);
    }
    /**
    * @returns {string}
...
export class Vec4 {
    ...
    */
    get 0() {
        const ret = wasm.__wbg_get_vec4_0(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set 0(arg0) {
        wasm.__wbg_set_vec4_0(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get 1() {
        const ret = wasm.__wbg_get_vec4_1(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set 1(arg0) {
        wasm.__wbg_set_vec4_1(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get 2() {
        const ret = wasm.__wbg_get_vec4_2(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set 2(arg0) {
        wasm.__wbg_set_vec4_2(this.ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get 3() {
        const ret = wasm.__wbg_get_vec4_3(this.ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set 3(arg0) {
        wasm.__wbg_set_vec4_3(this.ptr, arg0);
    }
    /**
...
function init(module) {
    ...
    imports.wbg.__wbg_loadWreScript_c02811bd9d7e0c37 = function(arg0, arg1, arg2) {
        const ret = loadWreScript(getStringFromWasm(arg0, arg1), arg2 >>> 0);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbg_instanceof_ArrayBuffer_d086c184cea3b074 = function(arg0) {
    ...
    imports.wbg.__wbg_length_deb426bb35063224 = function(arg0) {
        const ret = getObject(arg0).length;
        return ret;
    };
    imports.wbg.__wbg_new_8f74bcd603e235c0 = function(arg0) {
        const ret = new Uint8Array(getObject(arg0));
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_set_662b22f1b4008ab7 = function(arg0, arg1, arg2) {
        getObject(arg0).set(getObject(arg1), arg2 >>> 0);
    };
    imports.wbg.__wbg_newwithbyteoffsetandlength_65312ae9f476fdc1 = function(arg0, arg1, arg2) {
    ...
    imports.wbg.__wbindgen_closure_wrapper194 = function(arg0, arg1, arg2) {
        ...
        const real = () => {
            ...
            try {
                ...
                if (--state.cnt === 0) {
                    wasm.__wbg_function_table.get(21)(state.a, state.b);
                    state.a = 0;
                }
            }
        }
    ...
    imports.wbg.__wbindgen_closure_wrapper196 = function(arg0, arg1, arg2) {
        ...
        const real = (arg0) => {
            state.cnt++;
            try {
                return __wbg_elem_binding2(state.a, state.b, arg0);
            } finally {
                if (--state.cnt === 0) {
                    wasm.__wbg_function_table.get(21)(state.a, state.b);
                    state.a = 0;
