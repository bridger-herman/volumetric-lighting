...
impl FrameBuffer {
    ...
    pub fn render(
        &self,
        screen_quad_shader: &WebGlProgram,
        scene: &Option<Scene>,
    ) {
        wre_gl!().bind_framebuffer(WebGl2RenderingContext::FRAMEBUFFER, None);
        ...
        if let Some(scene) = scene {
            ...
            let num_point_light_location = wre_gl!().get_uniform_location(
                screen_quad_shader,
            ...
            let point_light_colors: Vec<f32> = scene
                ...
                .flatten()
                .collect();
            let point_light_colors_location = wre_gl!().get_uniform_location(
                screen_quad_shader,
            ...
            let num_spot_light_location = wre_gl!().get_uniform_location(
                screen_quad_shader,
                "uni_num_spot_lights",
            );
            wre_gl!().uniform1i(
            ...
            let spot_light_positions: Vec<f32> = scene
                ...
                .flatten()
                .collect();
            let spot_light_positions_location = wre_gl!().get_uniform_location(
                screen_quad_shader,
            ...
            let spot_light_colors: Vec<f32> = scene
                ...
                .flatten()
                .collect();
            let spot_light_colors_location = wre_gl!().get_uniform_location(
                screen_quad_shader,
